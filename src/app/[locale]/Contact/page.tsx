  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await poster(
        "/portal-interactions/create-contact-us",
        data
      );
      setSuccess(true);
                ...
                <form onSubmit={handleSubmit}>
                  <div className="relative mb-6" data-te-input-wrapper-init>
                    <input
                      ...
                      className="peer block min-h-[auto] w-full rounded border-2 bg-transparent py-[0.72rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
                      id="exampleInput90"
                    />
                    <label
                  ...
                  <div className="relative mb-6" data-te-input-wrapper-init>
                    <textarea
                      ...
                      className="peer block min-h-[auto] w-full rounded border-2 bg-transparent py-[2rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
                  ...
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                    <div className="flex items-start">
                      ...
                      <div className="ml-6 grow">
                        ...
                        <p className="text-sm text-neutral-500">abcd xyz</p>
                      </div>
                    </div>
                  </div>
